    ...
    return {
        ...
        template:`
          <div>
           ...
           <table ng-if="loaded">
            <tr>
             <th ng-repeat="day in days track by $index" class="day-header">
               {{day}}
             </th>
            </tr>
  ...
  return {
    ...
    controller: function($scope, $rootScope, $timeout) {
      ...
      $scope.cellClicked = function() {
        ...
        // 此处导致性能问题：（http://glebbahmutov.com/blog/angular-plus-react-equals-speed-revisited/）
        // 因为 $timeout 会用 $rootScope.$apply() 进行全部数据检查
        // $timeout(function() {
