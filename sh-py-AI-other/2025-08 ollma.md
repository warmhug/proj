...
- llama3.2:1b 或 llama3.2:3b	1B / 3B	Meta 新出的小模型，支持工具调用（需用 Instruct 版本），极轻量
...
ollama serve
OLLAMA_HOST=127.0.0.1:8000 ollama serve  # curl http://localhost:8000
