...
1. 打开 `chrome://extensions/` 相应的插件名、点“刷新”按钮。
...
设置/更新软连接: `ln -sf "$HOME/inner/a/_proj/ext-chrome/a_sh_nm.json" "$HOME/Library/Application Support/Google/Chrome/NativeMessagingHosts/a_sh_nm.json"`


## 记录

由于公司禁用本地 chrome 插件, 删除 manifest.json 里的如下字段
```json
