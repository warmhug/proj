...
public class Base {
    ...
    public class Inner {
        ...
        public void show() {
            ...
            System.out.println("welcome to " + Base.this.name);
            System.out.println("welcome to " + Base.this.age);
        }
    }
    ...
    public  static class SInner {
        ...
        public void show() {
            System.out.println("访问外部类中的score：" + Base.score);
